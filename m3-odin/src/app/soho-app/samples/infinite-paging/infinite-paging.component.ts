   ...
   private initGrid() {
      const options: SohoDataGridOptions = {
         ...
         columns: [
            {
               ...
               resizable: true, filterType: 'text', sortable: false
            },
            {
            ...
            {
               width: 'auto', id: 'col-phno', field: 'PHNO', name: 'Phone number',
               resizable: true, filterType: 'text', sortable: false
            },
            {
               width: 'auto', id: 'col-yref', field: 'YREF', name: 'Your reference',
               resizable: true, filterType: 'text', sortable: false
            }
         ],
         dataset: [],
         ...
         source: (request: SohoDataGridSourceRequest, response: SohoDataGridResponseFunction) => {
            this.pagingService.getData(request).subscribe((result: IPagingResult) => response(result.items, result.request));
         }
      };
