...
describe('Util ArrayUtil', () => {
    ...
    it('should sort array', () => {
        ...
        expect(ArrayUtil.sortByProperty(array, 'foo')).toEqual([value4, value3, value2, value2, value1]);
        expect(array).toEqual([value4, value3, value2, value2, value1]); // array isn't immutable
        expect(ArrayUtil.sortByProperty(array, 'foo', { ignoreCase: true })).toEqual([value3, value2, value2, value4, value1]);
        expect(ArrayUtil.sortByProperty([value1, value2, value3], 'bar')).toEqual([value1, value2, value3]);
    });
    ...
    it('should remove item from array by predicate', () => {
        ...
        const predicate = jasmine.createSpy().and.returnValues(true, false, true, false);
        ...
        expect(predicate.calls.allArgs()).toEqual([[value1], [value2], [value3], [value2], [value1]]);
    });
    ...
    it('should find index of item from array by predicate', () => {
        ...
        expect(predicate.calls.allArgs()).toEqual([[value1], [value1], [value2], [value1], [value2], [value3], [value1]]);
    });
    ...
    it('should filter item from array by predicate', () => {
        ...
        expect(ArrayUtil.filterByPredicate(array, predicate)).toEqual([value1, value3]);
        expect(array).toEqual([value1, value2, value3, value1]);
        expect(predicate).toHaveBeenCalledTimes(4);
        expect(predicate.calls.allArgs()).toEqual([[value1], [value2], [value3], [value1]]);
    });
    ...
    it('should find all items from array by predicate', () => {
        ...
        expect(predicate.calls.allArgs()).toEqual([[value1], [value2], [value3], [value1], [value1], [value2], [value3], [value1]]);
    });
    ...
    it('should move item in array', () => {
        ...
        expect(array as any).toEqual([value1, value2, value1, undefined, undefined, value3]);
    });
    ...
    it('should swap items in array', () => {
        ...
        expect(array as any).toEqual([value1, undefined, value2, value1, , value3]);
    });
});
...
describe('Util HttpUtil', () => {
    ...
    it('should parse query', () => {
        expect(HttpUtil.parseQuery('?foo=bar&bar=foo')).toEqual({ foo: 'bar', bar: 'foo' });
    });
